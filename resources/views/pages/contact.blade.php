...
<!-- contact -->
	<div class="contact">
		<div class="container">
			<div class="contact-grids">
				<div class="col-md-4 contact-grid text-center animated wow slideInLeft" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<h4>{{ _lang('Address') }}</h4>
						<p>12K Street, 45 Building Road <span>Dhaka Uttara.</span></p>
					</div>
				</div>
				...
				<div class="col-md-4 contact-grid text-center animated wow slideInRight" data-wow-delay=".5s">
					<div class="contact-grid3">
						...
						<h4>{{ _lang('Email') }}</h4>
						<p><a href="mailto:info@example.com">shopifystore@gmail.com</a><span><a href="mailto:info@example.com">shopifystore@gmail.com</a></span></p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="map wow fadeInDown animated" data-wow-delay=".5s">
				<h3 class="tittle">{{ _lang('View On Map') }}</h3>
			...
			<h3 class="tittle">{{ _lang('Contact Form') }}</h3>

			 {!! Form::open(['url' => '/contact-message', 'method'=>'post']) !!}
