  ...
  <div class="sidebar-scroll">
   ...
   <ul class="sidebar-menu">
    ...
    <li class="sub-menu">
     ...
     <li class="sub-menu">
      <a href="{{url('/password-change')}}"" class="">
        <i class="icon-book"></i>
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>{{ _lang('Change Password') }}</h4>
                            <div class="tools">
                        ...
                        <div class="widget-body form">
                            ...
                            {!! Form::open(['url' => '/update-password','class'=>'cmxform form-horizontal','id'=>'signupForm','method'=>'post']) !!}
                             @csrf
                                 ...
                                 <div class="control-group ">
                                    <label for="firstname" class="control-label">{{ _lang('Old Password') }}</label>
                                    <div class="controls">
                                        <input class="span6 " style="color:blue;" type="Password"  required="" name="" placeholder="Old Password" />
                                        
                                    </div>
                                </div>
                                
                                <div class="control-group ">
                                    <label for="firstname" class="control-label">{{ _lang('New Password') }}</label>
                                    <div class="controls">
                                        <input class="span6 " style="color:blue;" type="Password"  required="" name="" placeholder="New Password" />
                                        
                                    </div>
                                </div>
                                 <div class="control-group ">
                                    <label for="firstname" class="control-label">{{ _lang('Confirm Password') }}</label>
                                    <div class="controls">
                                        <input class="span6 " style="color:blue;" type="Password"  required="" name="" placeholder="Confirm Password" />
                                ...
                                <div class="form-actions">
                                    <button class="btn btn-success" type="submit">{{ _lang('Update Password') }}</button>
