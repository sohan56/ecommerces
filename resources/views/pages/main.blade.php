	...
	<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="{{asset('public/assets/')}}/images/slide1.jpg" alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="{{asset('public/assets/')}}/images/slide2.jpg" alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="{{asset('public/assets/')}}/images/slide3.jpg" alt="Dummy Image" /></li>
				</ul>

				<!-- Slide Description Image Area (316 x 328) -->
				<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script"><img class="img-responsive" src="{{asset('public/assets/')}}/images/slide4.jpg" alt="Dummy Image" /></div></li>
						<li><div class="inner-script"><img class="img-responsive" src="{{asset('public/assets/')}}/images/slide5.jpg" alt="Dummy Image" /></div></li>
						<li><div class="inner-script"><img class="img-responsive" src="{{asset('public/assets/')}}/images/slide6.jpg" alt="Dummy Image" /></div></li>
					</ul>
		...
		<div class="sap_tabs">
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>{{ _lang('') }}</span></li> 
				...
				<div class="resp-tabs-container">
					...
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                          ...
                          @foreach($all_publish_product as $v_product)
