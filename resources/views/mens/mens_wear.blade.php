...
<div class="men-wear">
	<div class="container">
                         ...
                         $all_publish_category = DB::table('mens_category')
                             ...
                             ?>
								...
								<ul>
									...
									<li><a href="{{URL::to('mens-category',$v_category->category_id)}}">{{$v_category->category_name}}</a></li>
									 @endforeach
		...
		<div class="col-md-8 products-right">
				...
				<div style="float: right; margin-bottom: 45px;"   >
				    {!! Form::open(['url' => '/search-mproduct','method'=>'post']) !!}
				      <input type="text" name="search_text" size="30" height="10" placeholder="Search Mens products">
		...
		<div class="clearfix"></div>
		          <?php 
                      $all_publish_mproduct = DB::table('mens_product')
                         ->where('publication_status',1)
                                ->get();
		...
		<div class="single-pro">
			 ...
			 @foreach($all_publish_mproduct as $v_mproduct)
						...
						<img src="{{asset($v_mproduct->mproduct_img)}}" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
									<a href="{{URL::to('/add-to-mcart/' .$v_mproduct->mproduct_id)}}" class="link-product-add-cart">Quick View</a>
								</div>
							</div>
