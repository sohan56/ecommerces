...
<div class="men-wear">
	<div class="container">
							...
							<?php 
                             ...
                             ?>
								<ul>
									...
									<li><a href="{{URL::to('womens-category',$v_wcategory->wcategory_id)}}">{{$v_wcategory->wcategory_name}}</a></li>
									@endforeach
		...
		<div class="clearfix"></div>
		 <?php 
                      $all_publish_wproduct = DB::table('womens_product')
                         ->where('publication_status',1)
                           ->get();
		...
		<div class="single-pro">
             ...
             @foreach($all_publish_wproduct as $v_wproduct)
