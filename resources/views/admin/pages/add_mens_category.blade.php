                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> {{ _lang('Add Mens Category') }}</h4>
                            <div class="tools">
                        ...
                        <div class="widget-body form">
                            ...
                            {!! Form::open(['url' => '/save-mens-category','class'=>'cmxform form-horizontal','id'=>'signupForm','method'=>'post']) !!}
                             @csrf
                                <div class="control-group ">
                                    <label for="firstname" class="control-label">{{ _lang('Category Name') }}</label>
                                    <div class="controls">
                                        <input class="span6 " id="" name="category_name" type="text" required />
                                    </div>
                                </div>
                                <div class="control-group ">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea class="span6 " id="" name="category_description" type="text" required></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
