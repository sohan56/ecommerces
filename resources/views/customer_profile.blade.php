                             ...
                             @endphp
                                <table class="table" >
                                    ...
                                    <tr >
                                        ...
                                        <td><h4>{{ $customer->customer_name }}</h4></td>
                                       
                                    </tr>
                                    <tr>
                                        <td><h4><strong>Email:</strong></h4></td>
                                        <td><h4>{{ $customer->email_address }}</h4></td>
                                       
                                    </tr>
                                    <tr>
                                        <td><h4><strong>Mobile:</strong></h4></td>
                                        <td><h4>{{ $customer->mobile_number }}</h4></td>
                                     ...
                                     <tr>
                                        <td><h4><strong>Zip Code :</strong></h4></td>
                                        <td><h4>{{ $customer->zip_code }}</h4></td>
